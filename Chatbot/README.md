...
- In a terminal, navigate to `OneWay.Chatbot`

    ```bash
    # change into project folder
    cd OneWay.Chatbot/OneWay.Chatbot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `OneWay.Chatbot/OneWay.Chatbot` folder
  - Select `OneWay.Chatbot.csproj` file
...
Generated with `dotnet new OneWay.Chatbot` v4.7.0
